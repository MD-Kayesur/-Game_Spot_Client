...
const HighestReciew = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-4 gap-3">
            {HighestReciew.map(data=><div className="card   bg-base-100 shadow-xl p-4">
            <figure>
              <img
              ...
              <div className="flex items-center mt-2">
                <div className="rating">
                  {[...Array(5)].map((_, i) => (
                      ...
                      className={`mask mask-star-2 ${i < data.rating ? 'bg-yellow-900'  : 'bg-gray-300'}`} aria-label="1 star" /> 
                  ))}
...
<span className="ml-2 text-gray-600">{data.rating}/5</span>
              ...
              <div>
                 <NavLink to={`/reviewsdetails/${data._id}`} className='btn '> Explore Details</NavLink>
              </div>
            </div>
          </div> )}
        </div>
